...
// func (s *AdminSubscriptionService) GetSubscriptionByIDDetailed(ctx context.Context, subscriptionID uuid.UUID) (*AdminSubscriptionResponse, error) {
...
// func (s *AdminSubscriptionService) UpdateSubscriptionFields(ctx context.Context, subscriptionID uuid.UUID, updates map[string]any) error {
// 	subscription, err := s.SubscriptionRepo.GetByID(ctx, subscriptionID)
// 	if err != nil {
...
// func (s *AdminSubscriptionService) UpdateProductFields(ctx context.Context, productID uuid.UUID, updates map[string]any) error {
