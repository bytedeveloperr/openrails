...
proc_arrays AS (
    ...
    proc_spine AS (
        SELECT s.snapshot_date, d.currency AS currency, d.processor
        FROM spine s
...
SELECT
    ...
    proc_name AS processor_name,
    proc_active AS processor_active_subscriptions,
    proc_new AS processor_new_subscriptions,
    proc_cancel AS processor_cancellations,
    proc_rev_total AS processor_revenue_total_cents,
    proc_rev_sub AS processor_revenue_subscription_cents,
    proc_rev_one_time AS processor_revenue_one_time_cents,
    proc_refunds AS processor_revenue_refunds_cents,
    proc_chargebacks AS processor_revenue_chargebacks_cents,
    proc_pay_success AS processor_payments_successful,
    proc_pay_failed AS processor_payments_failed,
